...
\end{align}
 \begin{figure}[h!]
    \centering
    \includegraphics[width=6cm]{figs/x_n.eps}
    \caption{Input Signal  y(n)}
    \label{yn}
\end{figure}
...
\end{align}
 \begin{figure}[h!]
    \centering
    \includegraphics[width=6cm]{figs/X_fft.eps}
    \caption{FFT of input signal X(k)}
    \label{yn}
\end{figure}
...
\begin{figure}[]
    \centering
    \includegraphics[width=6cm]{figs/H_fft.eps}
...
\end{align}
 \begin{figure}[h!]
    \centering
    \includegraphics[width=6cm]{figs/y_(n).eps}
